...
$this->title = 'Статьи автора -'.' '. $aurhor->name;
?>
...
<div class="main-content">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <?  $i = 0;
                foreach ($aurhor as $aurthors) { if ($i === 0) { echo Breadcrumbs::widget(['homeLink' => ['label' => 'Главная', 'url' => '/'], 'links' => [ [
                                    'label' => $aurhor->name,
                                    'url' => ['site/author', 'id' => $aurhor->id],
                                    'template' => "<li><b>{link}</b></li>\n", // template for this link only
                                ],],]);++$i;
               }}  ;?>
                <h1 style="padding: 4px 4px 15px 4px;color: #444;font-size: 2em;">Автор статей <?php echo $aurhor->name ?> </h1>
                            ...
                            <div class="col-md-6">
                                <div class="post-content">
                                    <div class="entry-header ">
                                        ...
                                        <h6 ><a href="<?= Url::toRoute(['site/category','id'=>$article->category->id]);?>" style="font-size: 14px;font-weight: 400; line-height: 1;"> <i class="ion-ios-paper"></i><?= $article->category->title?></a></h6>
                                        <h6 ><a href="<?= Url::toRoute(['site/author', 'id' => $article->author->id]) ?>" style="font-size: 14px;font-weight: 400; line-height: 0;"><i class="ion-ios-person"></i><?= $article->author->name ?></a></h6>
